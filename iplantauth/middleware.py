...
class ShibbolethRemoteUserMiddleware(RemoteUserMiddleware):
    ...
    header=getattr(settings, 'SHIBBOLETH_USER_KEY', None)
    ...
    def process_request(self, request):
        ...
        try:
            ...
            if request.user.is_authenticated() and not getattr(settings, 'SHIBBOLETH_DJANGO_SESSION_MAY_OUTLIVE_SHIBBOLETH_SESSION', False):
